...
def validate_predictions(predictions: List[Dict[str, str]], validation_path: str = "../data/validation.parquet") -> float:
    """
    ...
    validation_set = pd.read_parquet(validation_path)
